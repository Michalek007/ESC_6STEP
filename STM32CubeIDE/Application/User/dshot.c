...
void DShot_TimerInit(DShotType dshotType, TIM_HandleTypeDef *tim, uint32_t channel) {
	...
	switch (dshotType) {
	case DSHOT150:
		prescaler = (SystemCoreClock / 150000 / arr) - 1;
		break;
	case DSHOT300:
		prescaler = (SystemCoreClock / 300000 / arr) - 1;
		break;
	case DSHOT600:
		prescaler = (SystemCoreClock / 600000 / arr) - 1;
		break;
	case DSHOT1200:
		prescaler = (SystemCoreClock / 1200000 / arr) - 1;
		break;
	default:
		break;
	}
