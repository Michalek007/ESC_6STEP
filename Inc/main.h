...
#define M1_BEMF_W_Pin LL_GPIO_PIN_2
#define M1_BEMF_W_GPIO_Port GPIOA
#define M1_CURRENT_REF_Pin LL_GPIO_PIN_6
#define M1_CURRENT_REF_GPIO_Port GPIOA
#define M1_BEMF_DIVIDER_Pin LL_GPIO_PIN_7
...
#define M1_ETR_Pin LL_GPIO_PIN_12
#define M1_ETR_GPIO_Port GPIOA
